        ...
        {confirmingDelete ? (
          <div className="mt-5">
            <p className="text-sm text-slate-600">
              Delete "{issue?.name}"? This can't be undone.
            </p>
            ...
            <div className="mt-5 flex justify-end gap-3">
              <button
                ...
                disabled={isDeleting}
                className="rounded-lg px-4 py-2.5 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isDeleting}
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-rose-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
              >
