...
public class AuthService : IAuthService
{
        ...
        LoginDto dto)
    {
        ...
        // so we don't leak which one occurred.
        if (user is null ||
    ...
    // Used for normal login, registration and Google login.
    ...
    public async Task<(string Token, UserDto User)> LoginWithGoogleAsync(
        string googleId,
        string email,
        string name)
    {
